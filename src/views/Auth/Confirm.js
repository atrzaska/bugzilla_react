...
import { confirmEmailSchema as schema } from 'src/services/yup'
...
const Confirm = () => {
  ...
  const {
    ...
    data,
    schema,
    onCreate: (data) => API.createConfirmation(data),
    successRedirectPath: '/signup/success',
  })
  ...
  return (
    <AuthLayout>
      <Form onSubmit={onSubmit} className="form-signin bg-white p-4">
        <h3 className="mb-3 font-weight-normal">Resend confirmation</h3>
