...
const Terms = () => (
  <LegalLayout>
    ...
    <p>
      ...
      Do not continue to use Bugzilla if you do not agree to take all of the
    ...
    <p>
      Unless otherwise stated, Bugzilla and/or its licensors own the
      intellectual property rights for all material on Bugzilla. All
      intellectual property rights are reserved. You may access this from
      Bugzilla for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from Bugzilla</li>
      <li>Sell, rent or sub-license material from Bugzilla</li>
      <li>Reproduce, duplicate or copy material from Bugzilla</li>
      <li>Redistribute content from Bugzilla</li>
    </ul>
    <p>This Agreement shall begin on the date hereof.</p>
    <p>
      Parts of this website offer an opportunity for users to post and exchange
      opinions and information in certain areas of the website. Bugzilla does
      ...
      Bugzilla,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Bugzilla shall not be liable for the
    ...
    <p>
      Bugzilla reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Bugzilla a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Bugzilla; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Bugzilla. Please include your name, your organization name,
    ...
    <p>
      No use of Bugzilla's logo or other artwork will be allowed for linking
