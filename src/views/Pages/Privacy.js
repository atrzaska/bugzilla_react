...
const Privacy = () => (
  <LegalLayout>
    <h1>Privacy Policy for Bugzilla</h1>
    <p>
      At Bugzilla, accessible from {appUrl}, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by Bugzilla and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in Bugzilla. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      Bugzilla follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Bugzilla uses 'cookies'. These cookies are used to
    ...
    <p>
      ...
      advertising partners of Bugzilla.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Bugzilla, which are sent directly
    ...
    <p>
      Note that Bugzilla has no access to or control over these cookies that are
      used by third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      Bugzilla's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Bugzilla does not knowingly collect any Personal Identifiable Information
